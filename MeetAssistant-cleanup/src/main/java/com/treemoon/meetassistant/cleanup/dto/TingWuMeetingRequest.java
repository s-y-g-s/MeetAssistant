...
@Data
public class TingWuMeetingRequest {
    ...
    private boolean AutoChaptersEnabled = false;//章节速览功能，包括：议程标题和议程摘要
    private boolean MeetingAssistanceEnabled = false;//关键词、待办事项、重点内容、场景识别
     ...
     * MindMap（思维导图）
     */
    private boolean SummarizationEnabled = false;//是否开启摘要总结功能。
